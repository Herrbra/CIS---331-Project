...
When it comes to sports, one of the biggest questions is, "Where are teams most successful". Our research and findings have analyzied where these teams do their best and why that might be. This data is extremely important to the team especially when it determines where they place in tournaments. The goal of this is to see if the teams do better at home or away games. 

We decided on 5 questions to give us a solution to our question of, "Where are teams most successful"?
...
Some important findings from our data analysis were that teams are 1.33 percent more likley to win at home when compared to away games. Also from the graphs in question 5, you can see that they win more on the graph.
